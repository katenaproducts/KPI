...
/****** Object:  StoredProcedure [dbo].[EXTGEN_ShipLotDefaultSp]    Script Date: 08/30/2017 15:48:47 ******/
SET ANSI_NULLS ON
GO
 ...
 * $NoKeywords: $
 */
CREATE PROCEDURE [dbo].[EXTGEN_ShipLotDefaultSp](
  @Site        SiteType = NULL
, @Whse        WhseType
, @Item        ItemType
, @Loc         LocType
