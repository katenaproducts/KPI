...
/****** Object:  StoredProcedure [dbo].[EXTGEN_CoPackingSlipLoadSp]    Script Date: 08/30/2017 15:48:11 ******/
SET ANSI_NULLS ON
GO
 ...
 * $NoKeywords: $
 */
CREATE PROCEDURE [dbo].[EXTGEN_CoPackingSlipLoadSp] (    
...
AND   coitem.qty_packed < qty_ordered
--(CASE WHEN @TPckCall = 'CO-SHIP'    
