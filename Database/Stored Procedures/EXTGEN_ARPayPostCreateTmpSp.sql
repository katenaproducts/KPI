...
/****** Object:  StoredProcedure [dbo].[ARPayPostCreateTmpSp]    Script Date: 09/06/2017 11:21:12 ******/
SET ANSI_NULLS ON
GO
 ...
 * $NoKeywords: $
 */
CREATE PROCEDURE [dbo].[ARPayPostCreateTmpSp] (
...
BEGIN
   ...
   WHERE arpmt.cust_num BETWEEN @PStartCustNum AND @PEndCustNum
     ...
     AND arpmt.type = @PType
      ...
      and case when @PType = 'C' and deposit_date is not null then deposit_date else recpt_date end not between @StartDate1 and @EndDate1
      )
   begin
